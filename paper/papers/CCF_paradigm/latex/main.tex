...
Our analysis is restricted to Canadian print media and cannot establish causation in the strict interventionist sense. Media conglomerates may republish wire copy across outlets, inflating convergence signals; the pipeline mitigates this through deduplication and penalisation (see \hyperref[sec:syndication]{Methods}), but residual effects cannot be excluded. Whether scientific dispossession translates into policy outcomes remains open. What is clear is that the discursive conditions under which scientific knowledge could inform public action have been progressively eroded.
