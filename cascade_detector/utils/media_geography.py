...
class MediaGeography:
    ...
    def _identify_linguistic_groups(self) -> None:
        ...
        """
        # Explicitly francophone outlets (name-based heuristics are unreliable,
        # e.g. "Edmonton Journal" is anglophone despite containing "Journal")
